...
class Question(BaseModel):
    ...
    body: str = Field(..., description="Question body, supports Markdown/HTML")
    question_images: List[str] = Field(default=[], description="List of image URLs")
    tags: List[str] = Field(default=[], description="Tags for categorization")

    projectId: Optional[PyObjectId] = Field(..., description="Reference to Project")
    askedBy: Optional[PyObjectId] = Field(..., description="Reference to User who asked")
    ...
    isResolved: bool = Field(default=False, description="Resolution status")
